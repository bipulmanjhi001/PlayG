...
public class ResultAdapter extends BaseAdapter {
    ...
    public ResultAdapter(ArrayList<EventList> itemArray, Context mContext) {
        super();
    ...
    public class ViewHolder {
        ...
        private TextView txtMap, txtDate, txtMatchNo;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            try {
                ...
                convertView = inflator.inflate(com.PlayG.R.layout.event_list, null);
